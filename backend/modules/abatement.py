...
class AbatementModule:
    ...
    def pback_time(self, elapsed: float, start_year: int = 2025) -> float:
    ...
    def cost_coeff(self, sigma: np.ndarray, elapsed: float, start_year: int = 2025) -> np.ndarray:
    ...
    def compute(self, cr: np.ndarray, sigma: np.ndarray, elapsed: float, start_year: int = 2025) -> np.ndarray:
    ...
    def marginal_abatement_cost(self, cr: np.ndarray, sigma: np.ndarray,
                                elapsed: float, start_year: int = 2025) -> np.ndarray:
